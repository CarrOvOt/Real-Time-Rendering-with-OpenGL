...
public:
    ...
    static void LatLong2Cube(unsigned int latlongMap, unsigned int cubeMap, unsigned int resolution) {
    ...
    static unsigned int LatLong2CubefromFile(const char* path, unsigned int resolution = 2048) {
    ...
    static unsigned int PrefilterMapfromEnvCube(unsigned int envMap, unsigned int mipNum = 5, unsigned int resolution = 256) {
    ...
    static unsigned int LoadBrdfLut(const char* path = "Resource/LUT/ibl_brdf_lut.png") {
    ...
    static unsigned int GenBrdfLut() {
    ...
    static unsigned int GenIrradiance(unsigned int envMap, unsigned int resolution = 512) {
